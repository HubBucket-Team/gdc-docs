...
The case page will also display the mutations in the case that are found the most frequently around the GDC. This information is displayed as a bar graph.
